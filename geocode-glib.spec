...
Source0  : https://download.gnome.org/sources/geocode-glib/3.26/geocode-glib-3.26.3.tar.xz
...
%prep
%setup -q -n geocode-glib-3.26.3
cd %{_builddir}/geocode-glib-3.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656691607
...
cp %{_builddir}/geocode-glib-3.26.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/geocode-glib/5fb362ef1680e635fe5fb212b55eef4db9ead48f
cp %{_builddir}/geocode-glib-3.26.3/icons/maki/LICENSE.txt %{buildroot}/usr/share/package-licenses/geocode-glib/b5707bf785ec22684c9374d06eaa874ffbf0d2b8
...
%files tests
%defattr(-,root,root,-)
/usr/share/installed-tests/geocode-glib/geo-uri
/usr/share/installed-tests/geocode-glib/geo-uri.test
/usr/share/installed-tests/geocode-glib/geocode-glib
...
/usr/share/installed-tests/geocode-glib/mock-backend
